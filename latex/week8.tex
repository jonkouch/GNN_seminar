...
\begin{frame}{Permutation Invariance}
    ...
    \begin{itemize}
        ...
        \pause
        \item $f:\mathbb{R}^n \rightarrow \mathbb{R}$ is permutation invariant if $f(x) = f(\pi x)$ for all $\pi \in H$.
    \end{itemize}
    \begin{center}
        \pause
...
\begin{frame}{\emph{DeepSets} Network}
    \begin{itemize}
        ...
        \item Ths keeps the general structure of the layer: a linear transformation of the distinct elements of the set summed with the mean of the set.  
    \end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{\emph{DeepSets} Expressivity}
    ...
    \pause
    \begin{theorem}
        A \emph{DeepSets} network is maximally expressive in the space of permutation invariant functions.
    \end{theorem}
    \pause
    \begin{proof}
        \pause
        H.W. (using standard results from approximation theory).
    \end{proof}
